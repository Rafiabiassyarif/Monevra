        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-base text-slate-600 dark:text-slate-400">
              <li><a href="/#features" className="hover:text-brand-500 dark:hover:text-brand-400 transition-colors">{t('footer.features')}</a></li>
              <li><a href="/#preview" className="hover:text-brand-500 dark:hover:text-brand-400 transition-colors">{t('footer.analytics')}</a></li>
              <li><a href="/#why-us" className="hover:text-brand-500 dark:hover:text-brand-400 transition-colors">{t('footer.security')}</a></li>
              <li><a href="/#preview" className="hover:text-brand-500 dark:hover:text-brand-400 transition-colors">{t('footer.dashboard')}</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-base text-slate-600 dark:text-slate-400">
              <li><a href="/#why-us" className="hover:text-brand-500 dark:hover:text-brand-400 transition-colors">{t('footer.about')}</a></li>
              <li><a href="/#contact" className="hover:text-brand-500 dark:hover:text-brand-400 transition-colors">{t('footer.help')}</a></li>
              <li><a href="/#contact" className="hover:text-brand-500 dark:hover:text-brand-400 transition-colors">{t('footer.contact')}</a></li>
              <li><Link to="/privacy" className="hover:text-brand-500 dark:hover:text-brand-400 transition-colors">{t('footer.privacy')}</Link></li>
              <li><Link to="/terms" className="hover:text-brand-500 dark:hover:text-brand-400 transition-colors">{t('footer.terms')}</Link></li>
            </ul>
          </div>
        </div>
